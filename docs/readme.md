...
| `rover`               | Deploy SkyWalking Rover and detect the processes in the Kubernetes environment.                                                            | Only Support Deploy to the Kubernetes environment, docker is not support.                                                             |
